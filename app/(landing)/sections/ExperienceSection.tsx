  ...
  useGSAP(
    () => {
      ...
      gsap.to(root, {
        ...
        scrollTrigger: {
          trigger: sectionRef.current,
          start: "top 60%", // triggers dark mode when top of section is 60% down the viewport
          end: "bottom 40%", // triggers light mode when bottom of section is 40% down the viewport
